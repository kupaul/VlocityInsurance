...
import { OMNIDEF } from './insDunningEnglish_def.js';
import tmpl from './insDunningEnglish.html';
import tmpl_nds from './insDunningEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insDunningEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
