...
import { OMNIDEF } from './insCreateStatementEnglish_def.js';
import tmpl from './insCreateStatementEnglish.html';
import tmpl_nds from './insCreateStatementEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insCreateStatementEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
