...
import { OMNIDEF } from './lwcInsuranceIssuePolicyEnglish_def.js';
import tmpl from './lwcInsuranceIssuePolicyEnglish.html';
import tmpl_nds from './lwcInsuranceIssuePolicyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lwcInsuranceIssuePolicyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
