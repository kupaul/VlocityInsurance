...
import { OMNIDEF } from './insWCPolicyPaymentEnglish_def.js';
import tmpl from './insWCPolicyPaymentEnglish.html';
import tmpl_nds from './insWCPolicyPaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insWCPolicyPaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
