...
import { OMNIDEF } from './propertyHomeQuoteHO3English_def.js';
import tmpl from './propertyHomeQuoteHO3English.html';
import tmpl_nds from './propertyHomeQuoteHO3English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class propertyHomeQuoteHO3English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
