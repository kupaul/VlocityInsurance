...
import { OMNIDEF } from './autoAddDriversEnglish_def.js';
import tmpl from './autoAddDriversEnglish.html';
import tmpl_nds from './autoAddDriversEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoAddDriversEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
