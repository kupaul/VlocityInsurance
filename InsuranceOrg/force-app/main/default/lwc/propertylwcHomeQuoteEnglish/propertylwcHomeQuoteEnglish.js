...
import { OMNIDEF } from './propertylwcHomeQuoteEnglish_def.js';
import tmpl from './propertylwcHomeQuoteEnglish.html';
import tmpl_nds from './propertylwcHomeQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class propertylwcHomeQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
