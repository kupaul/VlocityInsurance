...
import { OMNIDEF } from './lwcQuoteDocSmartCommEnglish_def.js';
import tmpl from './lwcQuoteDocSmartCommEnglish.html';
import tmpl_nds from './lwcQuoteDocSmartCommEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lwcQuoteDocSmartCommEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
