...
import { OMNIDEF } from './watercraftModifyCoveragesEnglish_def.js';
import tmpl from './watercraftModifyCoveragesEnglish.html';
import tmpl_nds from './watercraftModifyCoveragesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class watercraftModifyCoveragesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
