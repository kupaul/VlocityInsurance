...
import { OMNIDEF } from './lwcautoFNOLEnglish_def.js';
import tmpl from './lwcautoFNOLEnglish.html';
import tmpl_nds from './lwcautoFNOLEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lwcautoFNOLEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
