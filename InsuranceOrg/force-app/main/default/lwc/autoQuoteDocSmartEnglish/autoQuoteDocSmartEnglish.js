...
import { OMNIDEF } from './autoQuoteDocSmartEnglish_def.js';
import tmpl from './autoQuoteDocSmartEnglish.html';
import tmpl_nds from './autoQuoteDocSmartEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoQuoteDocSmartEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
