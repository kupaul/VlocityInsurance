...
import { OMNIDEF } from './insWIPSetupPaymentPlanEnglish_def.js';
import tmpl from './insWIPSetupPaymentPlanEnglish.html';
import tmpl_nds from './insWIPSetupPaymentPlanEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insWIPSetupPaymentPlanEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
