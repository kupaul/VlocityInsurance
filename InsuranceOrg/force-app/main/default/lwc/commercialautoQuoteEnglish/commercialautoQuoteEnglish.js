...
import { OMNIDEF } from './commercialautoQuoteEnglish_def.js';
import tmpl from './commercialautoQuoteEnglish.html';
import tmpl_nds from './commercialautoQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class commercialautoQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
