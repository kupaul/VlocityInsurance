...
import { OMNIDEF } from './propertylwcHomeQuoteHO3English_def.js';
import tmpl from './propertylwcHomeQuoteHO3English.html';
import tmpl_nds from './propertylwcHomeQuoteHO3English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class propertylwcHomeQuoteHO3English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
