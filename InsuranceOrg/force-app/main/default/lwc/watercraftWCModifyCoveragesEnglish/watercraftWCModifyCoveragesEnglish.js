...
import { OMNIDEF } from './watercraftWCModifyCoveragesEnglish_def.js';
import tmpl from './watercraftWCModifyCoveragesEnglish.html';
import tmpl_nds from './watercraftWCModifyCoveragesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class watercraftWCModifyCoveragesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
