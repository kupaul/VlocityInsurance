...
import { OMNIDEF } from './insSetUpBillsEnglish_def.js';
import tmpl from './insSetUpBillsEnglish.html';
import tmpl_nds from './insSetUpBillsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insSetUpBillsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
