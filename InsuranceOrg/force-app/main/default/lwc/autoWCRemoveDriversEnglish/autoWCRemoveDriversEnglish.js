...
import { OMNIDEF } from './autoWCRemoveDriversEnglish_def.js';
import tmpl from './autoWCRemoveDriversEnglish.html';
import tmpl_nds from './autoWCRemoveDriversEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoWCRemoveDriversEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
