...
import { OMNIDEF } from './insWCWIPIssueWIPEnglish_def.js';
import tmpl from './insWCWIPIssueWIPEnglish.html';
import tmpl_nds from './insWCWIPIssueWIPEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insWCWIPIssueWIPEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
