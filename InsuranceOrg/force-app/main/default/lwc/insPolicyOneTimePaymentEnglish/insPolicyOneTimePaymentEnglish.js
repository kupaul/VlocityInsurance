...
import { OMNIDEF } from './insPolicyOneTimePaymentEnglish_def.js';
import tmpl from './insPolicyOneTimePaymentEnglish.html';
import tmpl_nds from './insPolicyOneTimePaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insPolicyOneTimePaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
