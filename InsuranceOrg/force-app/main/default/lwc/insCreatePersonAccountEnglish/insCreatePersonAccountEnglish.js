...
import { OMNIDEF } from './insCreatePersonAccountEnglish_def.js';
import tmpl from './insCreatePersonAccountEnglish.html';
import tmpl_nds from './insCreatePersonAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insCreatePersonAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
