...
import { OMNIDEF } from './insWCDunningEnglish_def.js';
import tmpl from './insWCDunningEnglish.html';
import tmpl_nds from './insWCDunningEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insWCDunningEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
