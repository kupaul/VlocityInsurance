...
import { OMNIDEF } from './autoQuoteEnglish_def.js';
import tmpl from './autoQuoteEnglish.html';
import tmpl_nds from './autoQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
