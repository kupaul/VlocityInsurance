...
import { OMNIDEF } from './bopWCQuoteEnglish_def.js';
import tmpl from './bopWCQuoteEnglish.html';
import tmpl_nds from './bopWCQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bopWCQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
