...
import { OMNIDEF } from './insPolicyCancellationEnglish_def.js';
import tmpl from './insPolicyCancellationEnglish.html';
import tmpl_nds from './insPolicyCancellationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insPolicyCancellationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
