...
import { OMNIDEF } from './commercialautoReusableVehicleInputEnglish_def.js';
import tmpl from './commercialautoReusableVehicleInputEnglish.html';
import tmpl_nds from './commercialautoReusableVehicleInputEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class commercialautoReusableVehicleInputEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
