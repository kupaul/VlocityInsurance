...
import { OMNIDEF } from './propertyHomeQuoteEnglish_def.js';
import tmpl from './propertyHomeQuoteEnglish.html';
import tmpl_nds from './propertyHomeQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class propertyHomeQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
