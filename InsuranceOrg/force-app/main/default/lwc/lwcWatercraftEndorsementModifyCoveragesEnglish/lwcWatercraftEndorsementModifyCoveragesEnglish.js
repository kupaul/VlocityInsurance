...
import { OMNIDEF } from './lwcWatercraftEndorsementModifyCoveragesEnglish_def.js';
import tmpl from './lwcWatercraftEndorsementModifyCoveragesEnglish.html';
import tmpl_nds from './lwcWatercraftEndorsementModifyCoveragesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lwcWatercraftEndorsementModifyCoveragesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
