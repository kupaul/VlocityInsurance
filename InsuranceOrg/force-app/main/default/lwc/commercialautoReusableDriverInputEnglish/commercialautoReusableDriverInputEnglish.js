...
import { OMNIDEF } from './commercialautoReusableDriverInputEnglish_def.js';
import tmpl from './commercialautoReusableDriverInputEnglish.html';
import tmpl_nds from './commercialautoReusableDriverInputEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class commercialautoReusableDriverInputEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
