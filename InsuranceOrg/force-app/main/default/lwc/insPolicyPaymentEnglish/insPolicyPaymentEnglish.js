...
import { OMNIDEF } from './insPolicyPaymentEnglish_def.js';
import tmpl from './insPolicyPaymentEnglish.html';
import tmpl_nds from './insPolicyPaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insPolicyPaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
