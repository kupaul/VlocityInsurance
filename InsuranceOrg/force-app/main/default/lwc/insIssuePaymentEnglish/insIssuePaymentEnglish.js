...
import { OMNIDEF } from './insIssuePaymentEnglish_def.js';
import tmpl from './insIssuePaymentEnglish.html';
import tmpl_nds from './insIssuePaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insIssuePaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
