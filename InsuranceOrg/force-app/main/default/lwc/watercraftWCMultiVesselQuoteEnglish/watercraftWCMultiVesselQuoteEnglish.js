...
import { OMNIDEF } from './watercraftWCMultiVesselQuoteEnglish_def.js';
import tmpl from './watercraftWCMultiVesselQuoteEnglish.html';
import tmpl_nds from './watercraftWCMultiVesselQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class watercraftWCMultiVesselQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
