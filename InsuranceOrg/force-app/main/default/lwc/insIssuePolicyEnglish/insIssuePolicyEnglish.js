...
import { OMNIDEF } from './insIssuePolicyEnglish_def.js';
import tmpl from './insIssuePolicyEnglish.html';
import tmpl_nds from './insIssuePolicyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insIssuePolicyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
