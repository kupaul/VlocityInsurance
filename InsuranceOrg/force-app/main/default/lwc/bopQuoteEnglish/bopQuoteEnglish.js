...
import { OMNIDEF } from './bopQuoteEnglish_def.js';
import tmpl from './bopQuoteEnglish.html';
import tmpl_nds from './bopQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bopQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
