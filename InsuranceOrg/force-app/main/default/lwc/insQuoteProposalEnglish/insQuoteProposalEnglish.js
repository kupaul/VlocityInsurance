...
import { OMNIDEF } from './insQuoteProposalEnglish_def.js';
import tmpl from './insQuoteProposalEnglish.html';
import tmpl_nds from './insQuoteProposalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insQuoteProposalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
