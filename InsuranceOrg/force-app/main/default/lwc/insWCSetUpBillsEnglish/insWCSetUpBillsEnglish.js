...
import { OMNIDEF } from './insWCSetUpBillsEnglish_def.js';
import tmpl from './insWCSetUpBillsEnglish.html';
import tmpl_nds from './insWCSetUpBillsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insWCSetUpBillsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
