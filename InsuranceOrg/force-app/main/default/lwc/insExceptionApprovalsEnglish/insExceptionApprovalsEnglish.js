...
import { OMNIDEF } from './insExceptionApprovalsEnglish_def.js';
import tmpl from './insExceptionApprovalsEnglish.html';
import tmpl_nds from './insExceptionApprovalsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insExceptionApprovalsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
