...
import { OMNIDEF } from './autoWCAddDriversEnglish_def.js';
import tmpl from './autoWCAddDriversEnglish.html';
import tmpl_nds from './autoWCAddDriversEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoWCAddDriversEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
