...
import { OMNIDEF } from './insWCProcessAutoPayEnglish_def.js';
import tmpl from './insWCProcessAutoPayEnglish.html';
import tmpl_nds from './insWCProcessAutoPayEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insWCProcessAutoPayEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
