...
import { OMNIDEF } from './watercraftMultiVesselQuoteEnglish_def.js';
import tmpl from './watercraftMultiVesselQuoteEnglish.html';
import tmpl_nds from './watercraftMultiVesselQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class watercraftMultiVesselQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
