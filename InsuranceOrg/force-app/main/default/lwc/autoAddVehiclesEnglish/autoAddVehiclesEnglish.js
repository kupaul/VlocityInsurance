...
import { OMNIDEF } from './autoAddVehiclesEnglish_def.js';
import tmpl from './autoAddVehiclesEnglish.html';
import tmpl_nds from './autoAddVehiclesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoAddVehiclesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
