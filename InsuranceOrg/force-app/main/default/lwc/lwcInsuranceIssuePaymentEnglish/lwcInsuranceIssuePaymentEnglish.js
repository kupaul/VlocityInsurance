...
import { OMNIDEF } from './lwcInsuranceIssuePaymentEnglish_def.js';
import tmpl from './lwcInsuranceIssuePaymentEnglish.html';
import tmpl_nds from './lwcInsuranceIssuePaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lwcInsuranceIssuePaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
