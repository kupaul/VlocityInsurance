...
import { OMNIDEF } from './autoModifyCoveragesEnglish_def.js';
import tmpl from './autoModifyCoveragesEnglish.html';
import tmpl_nds from './autoModifyCoveragesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoModifyCoveragesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
