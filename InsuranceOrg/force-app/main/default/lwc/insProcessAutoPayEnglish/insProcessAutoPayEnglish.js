...
import { OMNIDEF } from './insProcessAutoPayEnglish_def.js';
import tmpl from './insProcessAutoPayEnglish.html';
import tmpl_nds from './insProcessAutoPayEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insProcessAutoPayEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
