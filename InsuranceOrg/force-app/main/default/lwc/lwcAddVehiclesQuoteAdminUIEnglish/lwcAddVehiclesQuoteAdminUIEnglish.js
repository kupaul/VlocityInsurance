...
import { OMNIDEF } from './lwcAddVehiclesQuoteAdminUIEnglish_def.js';
import tmpl from './lwcAddVehiclesQuoteAdminUIEnglish.html';
import tmpl_nds from './lwcAddVehiclesQuoteAdminUIEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lwcAddVehiclesQuoteAdminUIEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
