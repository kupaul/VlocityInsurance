...
import { OMNIDEF } from './autoRemoveVehiclesEnglish_def.js';
import tmpl from './autoRemoveVehiclesEnglish.html';
import tmpl_nds from './autoRemoveVehiclesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoRemoveVehiclesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
