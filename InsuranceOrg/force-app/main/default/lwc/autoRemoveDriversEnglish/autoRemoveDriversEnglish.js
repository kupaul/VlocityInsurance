...
import { OMNIDEF } from './autoRemoveDriversEnglish_def.js';
import tmpl from './autoRemoveDriversEnglish.html';
import tmpl_nds from './autoRemoveDriversEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoRemoveDriversEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
