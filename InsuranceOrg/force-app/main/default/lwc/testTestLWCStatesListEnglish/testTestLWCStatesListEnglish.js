...
import { OMNIDEF } from './testTestLWCStatesListEnglish_def.js';
import tmpl from './testTestLWCStatesListEnglish.html';
import tmpl_nds from './testTestLWCStatesListEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testTestLWCStatesListEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
