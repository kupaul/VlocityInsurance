...
import { OMNIDEF } from './insWCExceptionApprovalsEnglish_def.js';
import tmpl from './insWCExceptionApprovalsEnglish.html';
import tmpl_nds from './insWCExceptionApprovalsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class insWCExceptionApprovalsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api layout;
    @api recordId;
