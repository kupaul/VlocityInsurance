...
angular.module('hybridCPQ', ['vlocity', 'CardFramework' , 'sldsangular', 'ngSanitize', 'forceng', 'tmh.dynamicLocale', 'cfp.hotkeys', 'VlocityDynamicForm', 'i18', 'LZString'])
    ...
    .config(['remoteActionsProvider', function(remoteActionsProvider) {
        ...
        'CPQReplace','CPQNew','CPQCompare','CPQCompareChanges','CPQCompareCurrent','CPQCompareReplacementQuote','CPQReplacementPopUpHeading','CPQReplacementPopUpMessage','CPQApplyReplacementMessage','CPQItemCanNotBeReplaced',
        'CPQReplacementNotFound','CPQName','CPQDescription','CPQApplyDiscountToItems','CPQMatchingCriteriaBelow','CPQReplaceSuccess','CPQNewCustomDiscount','CPQCreateCustomDiscount','CPQActive','CPQSubmit','CPQFindingReplacements','Activated','CPQPendingDeactivation','CPQPendingActivation','CPQDeactivated','CPQAppliesToAllItems'];
...
},{"./I18Translations.js":2,"./modules/hybridCPQ/constant/baseConstants.js":3,"./modules/hybridCPQ/controller/CPQCartController.js":4,"./modules/hybridCPQ/controller/CPQCartItemCellController.js":5,"./modules/hybridCPQ/controller/CPQCartItemConfigController.js":6,"./modules/hybridCPQ/controller/CPQCartItemController.js":7,"./modules/hybridCPQ/controller/CPQCartItemDetailsController.js":8,"./modules/hybridCPQ/controller/CPQController.js":9,"./modules/hybridCPQ/controller/CPQDiscountsController.js":10,"./modules/hybridCPQ/controller/CPQDiscountsItemController.js":11,"./modules/hybridCPQ/controller/CPQHeaderController.js":12,"./modules/hybridCPQ/controller/CPQItemsController.js":13,"./modules/hybridCPQ/controller/CPQPricelistsController.js":14,"./modules/hybridCPQ/controller/CPQProductItemController.js":15,"./modules/hybridCPQ/controller/CPQProductItemDetailsController.js":16,"./modules/hybridCPQ/controller/CPQPromotionItemController.js":17,"./modules/hybridCPQ/controller/CPQPromotionsController.js":18,"./modules/hybridCPQ/controller/CPQReplaceItemController.js":19,"./modules/hybridCPQ/controller/CPQTotalController.js":20,"./modules/hybridCPQ/directive/CPQHelper.js":21,"./modules/hybridCPQ/directive/CPQProductItemTreeView.js":22,"./modules/hybridCPQ/factory/CPQAdjustmentService.js":23,"./modules/hybridCPQ/factory/CPQCancelOrderService.js":24,"./modules/hybridCPQ/factory/CPQCardinalityService.js":25,"./modules/hybridCPQ/factory/CPQCartItemConfigService.js":26,"./modules/hybridCPQ/factory/CPQCartItemCrossActionService.js":27,"./modules/hybridCPQ/factory/CPQDiscountService.js":28,"./modules/hybridCPQ/factory/CPQDynamicMessagesService.js":29,"./modules/hybridCPQ/factory/CPQItemDetailsService.js":30,"./modules/hybridCPQ/factory/CPQLevelBasedApproachService.js":31,"./modules/hybridCPQ/factory/CPQOverrideService.js":32,"./modules/hybridCPQ/factory/CPQProductPromoListService.js":33,"./modules/hybridCPQ/factory/CPQResponsiveHelper.js":34,"./modules/hybridCPQ/factory/CPQService.js":35,"./modules/hybridCPQ/factory/CPQSettingsService.js":36,"./modules/hybridCPQ/factory/CPQStreamingChannelService.js":37,"./modules/hybridCPQ/services/CPQCustomViewsService.js":38,"./modules/hybridCPQ/services/CPQUtilityService.js":39,"./modules/hybridCPQ/templates/templates.js":40}],2:[function(require,module,exports){
angular
...
},{"./modules/i18Translations/directives/CPQTranslateDirective.js":41,"./modules/i18Translations/filters/CPQTranslateFilter.js":42,"./modules/i18Translations/services/CPQTranslateResourcesService.js":43,"./modules/i18Translations/services/CPQTranslateService.js":44}],3:[function(require,module,exports){
...
angular.module('hybridCPQ')
  .controller('CPQCartItemConfigController', ['$scope', '$rootScope', '$log', '$timeout', '$sldsModal', '$sldsToast', 'CPQ_CONST', 'pageService', 'CPQService', 'CPQSettingsService', 'CPQCartItemCrossActionService', 'CPQUtilityService', 'CPQCartItemConfigService','CPQTranslateService','TRANSLATION_FIELDS',
    ...
    $scope.selectPremises = function(records) {
        if(records && $rootScope.selectedPremises && $rootScope.selectedPremises.Id) {
            for(var i=0; i<records.length; i++) {
                if(records[i].Id.value === $rootScope.selectedPremises.Id.value) {
    ...
    $scope.getServicePoints = function(premises) {
        if(!premises || !premises.actions
            || !premises.actions.getservicepoints) {
            return;
        }
        CPQService.invokeAction(premises.actions.getservicepoints).then(
            function(data) {
                $log.debug(data);
                $scope.servicePointList = data.records;
            }, function(error) {
                $log.error(error);
            });
    }
    ...
    */
    ...
    $scope.isAccountDisabled = function(item) {
        var provisioningStatus = item.provisioningStatus && item.provisioningStatus.toLowerCase(); 
        return (provisioningStatus === 'deleted' || provisioningStatus === 'active' || provisioningStatus === 'changed' || item.orderActive) ? true : false;
    };
  ...
  .controller('CPQCartItemController', ['$scope', '$rootScope', '$log', '$timeout', '$sldsModal', '$sldsPrompt', '$sldsToast', '$q', '$filter', 'CPQ_CONST', 'CPQService', 'CPQSettingsService', 'CPQOverrideService', 'CPQCardinalityService', 'CPQItemDetailsService', 'CPQCartItemCrossActionService', 'CPQLevelBasedApproachService', 'CPQAdjustmentService', 'CPQResponsiveHelper', 'PromiseQueueFactory', 'CPQUtilityService','CPQTranslateService','TRANSLATION_FIELDS',
    function($scope, $rootScope, $log, $timeout, $sldsModal, $sldsPrompt, $sldsToast, $q, $filter, CPQ_CONST, CPQService, CPQSettingsService, CPQOverrideService, CPQCardinalityService, CPQItemDetailsService, CPQCartItemCrossActionService, CPQLevelBasedApproachService, CPQAdjustmentService, CPQResponsiveHelper, PromiseQueueFactory , CPQUtilityService, CPQTranslateService, TRANSLATION_FIELDS) {
        ...
        var labelsArray = ['CPQProducts','CPQPromotions','CPQDiscounts', 'CPQFilter','CPQProductConfig','CPQChangePrice',
                ...
                'CPQCompare','CPQCompareChanges', 'CPQCompareCurrent', 'CPQCompareReplacementQuote'];
        ...
        */
        ...
        $scope.checkActionsAndCardinality = function(parent, addonChildProduct, lineItemModal) {
            if ((addonChildProduct.actions.updateitems && !lineItemModal) ||
             (addonChildProduct.actions.addtocart && $scope.checkCardinalityForAdd(parent, addonChildProduct)) ||
             (addonChildProduct.actions.cloneitem && $scope.checkCardinalityForClone(parent, addonChildProduct)) || 
             (addonChildProduct.actions.deleteitem && $scope.checkCardinalityForDelete(parent, addonChildProduct))) {
                return true;
            }
        };
        ...
        */
        ...
        var isProvisioningStatusActiveOrChanged = function(item) {
            return (item.provisioningStatus && (item.provisioningStatus.toLowerCase() === 'active' || item.provisioningStatus.toLowerCase() === 'changed')) ? true : false;
        };
        ...
        $scope.isAsset = function(item, fieldName, parentPsDeleted) {
            return ($scope.isProvisioningStatusDeleted(item,parentPsDeleted) || CPQService.isAsset(item,fieldName)  || item.orderActive) ? true : false;
        };
        ...
        */
        ...
        $scope.delete = function(parent, itemObject, isConfirmationModal) {
            ...
            function deleteItem() {
                ...
                $scope.isDeleting = !isProvisioningStatusActiveOrChanged(itemObject);
        ...
        var deletePromise = function(parent, itemObject, processingToastMessage, deleteItemActionObjName) {
            ...
            CPQService.invokeAction(deleteActionObj).then(function(data) {
                ...
                $scope.isDeleting = updateSuccessful ? !isProvisioningStatusActiveOrChanged(itemObject) : false;
                ...
                if (!hasError || updateSuccessful) {
                    ...
                    if (!data.records || data.records.length === 0) {
                    ...
                    else if ($scope.isProvisioningStatusDeleted(data.records[0])) {
                        ...
                        if (isProvisioningStatusActiveOrChanged(itemObject)) {
...
function($scope, $rootScope, $log, $sldsToast, $sldsPrompt, CPQ_CONST, CPQService, CPQCustomViewsService, PromiseQueueFactory, CPQDiscountService, CPQTranslateService, TRANSLATION_FIELDS) {
    ...
    $scope.shouldShowDiscountStatus = function (record) {
        if (record[$rootScope.nsPrefix + 'Action__c']) {
            return record[$rootScope.nsPrefix + 'Action__c'].value === 'New' || record[$rootScope.nsPrefix + 'Action__c'].value === 'Deactivate' || record[$rootScope.nsPrefix + 'Action__c'].value === 'Change' ? true : false;
        }
    };
...
angular.module('hybridCPQ')
    .controller('CPQHeaderController', ['$scope', '$rootScope', '$log', '$q', '$timeout', '$window', '$sldsToast', '$sldsPrompt', 'CPQ_CONST', 'CPQService', 'CPQCancelOrderService', 'CPQStreamingChannelService', 'PromiseQueueFactory',
        function($scope, $rootScope, $log, $q, $timeout, $window, $sldsToast, $sldsPrompt, CPQ_CONST, CPQService, CPQCancelOrderService, CPQStreamingChannelService, PromiseQueueFactory) {
       ...
       $scope.progress = CPQCancelOrderService.progress;
        ...
        /* Custom Labels */
        $scope.customLabels = {};
        var labelsArray = ['CPQCancelOrder','CPQCancelOrderLocked','CPQShowMore'];
        CPQService.setLabels(labelsArray, $scope.customLabels);
        /********* Cancel Order **********/
...
angular.module('hybridCPQ')
 ...
 function($scope, $rootScope, $sldsModal, $sldsToast, CPQService, CPQSettingsService, CPQProductPromoListService,CPQ_CONST,CPQUtilityService) {
    ...
    $scope.customLabels = {};
    var toastCustomLabels = {};
    var labelsArray = ['CPQAddToCart','CPQClose','CPQMore','CPQOr','CPQApply','CPQCancel','CPQReplace','CPQReplacementPopUpHeading','CPQReplacementPopUpMessage'];
            ...
            if (addonProductFromAPI && addonProductFromAPI.minQuantity === 0 && addonProductFromAPI.defaultQuantity > 0) {
                ...
                if (!parentInCardData.actions || (parentInCardData.actions && !parentInCardData.actions.getproducts)) {
                    ...
                    for (i = 0; i < numOfLineItemsUnderParent; i++) {
                        ...
                        provisioningStatusDeleted = lineItemUnderParent[$rootScope.nsPrefix + 'ProvisioningStatus__c'] && lineItemUnderParent[$rootScope.nsPrefix + 'ProvisioningStatus__c'].value.toLowerCase() === 'deleted' ? true : false;

                        // Only lineItems of parent that are not "Deleted" in its provisioning status would be counted as actual instance of the optional addOn
                        if (!provisioningStatusDeleted && (lineItemUnderParent.PricebookEntry.Product2.Id === addonProductFromAPI.Product2.Id)) {
...
angular.module('hybridCPQ')
    ...
    return {
        ...
        isAsset: function(item,fieldName) {
            return (item.provisioningStatus && (item.orderActive || item.provisioningStatus.toLowerCase() === 'active' || item.provisioningStatus.toLowerCase() === 'changed')) ? true : false;
        },
             ...
             self.translateAttributeObj =  function(itemObject, preHookCallback) {
                 ...
                 if (itemObject.productAttributes &&
                    itemObject.productAttributes.records) {
                        ...
                        if (itemObject.productAttributes.records && itemObject.productAttributes.records > 0) {
                            itemObject
                                .productAttributes
                                .records
                                .map(function(productAttribute) {
