...
angular.module('hybridCPQ', ['vlocity', 'CardFramework' , 'sldsangular', 'ngSanitize', 'forceng', 'tmh.dynamicLocale', 'cfp.hotkeys', 'VlocityDynamicForm', 'i18', 'LZString'])
    ...
    .config(['remoteActionsProvider', function(remoteActionsProvider) {
        ...
        'CPQReplace','CPQNew','CPQCompare','CPQCompareChanges','CPQCompareCurrentState','CPQCompareFutureState','CPQReplacementPopUpHeading','CPQReplacementPopUpMessage','CPQApplyReplacementMessage','CPQItemCanNotBeReplaced',
        ...
        'Activated','CPQPendingDeactivation','CPQPendingActivation','CPQDeactivated','CPQAppliesToAllItems','CPQReplacePopUpPlanSingular','CPQReplacePopUpPlanPrural','CPQReplacePopUpYouHaveString'];
...
},{"./I18Translations.js":2,"./modules/hybridCPQ/constant/baseConstants.js":3,"./modules/hybridCPQ/controller/CPQBundleTransformController.js":4,"./modules/hybridCPQ/controller/CPQCartController.js":5,"./modules/hybridCPQ/controller/CPQCartItemCellController.js":6,"./modules/hybridCPQ/controller/CPQCartItemConfigController.js":7,"./modules/hybridCPQ/controller/CPQCartItemController.js":8,"./modules/hybridCPQ/controller/CPQCartItemDetailsController.js":9,"./modules/hybridCPQ/controller/CPQController.js":10,"./modules/hybridCPQ/controller/CPQDiscountsController.js":11,"./modules/hybridCPQ/controller/CPQDiscountsItemController.js":12,"./modules/hybridCPQ/controller/CPQHeaderController.js":13,"./modules/hybridCPQ/controller/CPQItemsController.js":14,"./modules/hybridCPQ/controller/CPQPricelistsController.js":15,"./modules/hybridCPQ/controller/CPQProductItemController.js":16,"./modules/hybridCPQ/controller/CPQProductItemDetailsController.js":17,"./modules/hybridCPQ/controller/CPQPromotionItemController.js":18,"./modules/hybridCPQ/controller/CPQPromotionsController.js":19,"./modules/hybridCPQ/controller/CPQReplaceItemController.js":20,"./modules/hybridCPQ/controller/CPQTotalController.js":21,"./modules/hybridCPQ/controller/multiservice/MultiServiceCPQBaseController.js":22,"./modules/hybridCPQ/controller/multiservice/MultiServiceCPQGroupController.js":23,"./modules/hybridCPQ/controller/multiservice/MultiServiceCPQGroupTotalController.js":24,"./modules/hybridCPQ/directive/CPQHelper.js":25,"./modules/hybridCPQ/directive/CPQProductItemTreeView.js":26,"./modules/hybridCPQ/directive/CPQRecordCategoryTreeView.js":27,"./modules/hybridCPQ/factory/CPQAdjustmentService.js":28,"./modules/hybridCPQ/factory/CPQBundleTransformService.js":29,"./modules/hybridCPQ/factory/CPQCancelOrderService.js":30,"./modules/hybridCPQ/factory/CPQCardinalityService.js":31,"./modules/hybridCPQ/factory/CPQCartItemConfigService.js":32,"./modules/hybridCPQ/factory/CPQCartItemCrossActionService.js":33,"./modules/hybridCPQ/factory/CPQDiscountService.js":34,"./modules/hybridCPQ/factory/CPQDynamicMessagesService.js":35,"./modules/hybridCPQ/factory/CPQItemDetailsService.js":36,"./modules/hybridCPQ/factory/CPQLevelBasedApproachService.js":37,"./modules/hybridCPQ/factory/CPQOverrideService.js":38,"./modules/hybridCPQ/factory/CPQProductPromoListService.js":39,"./modules/hybridCPQ/factory/CPQResponsiveHelper.js":40,"./modules/hybridCPQ/factory/CPQService.js":41,"./modules/hybridCPQ/factory/CPQSettingsService.js":42,"./modules/hybridCPQ/factory/CPQStreamingChannelService.js":43,"./modules/hybridCPQ/services/CPQCustomViewsService.js":44,"./modules/hybridCPQ/services/CPQUtilityService.js":45,"./modules/hybridCPQ/services/multiservice/MultiServiceCPQService.js":46,"./modules/hybridCPQ/templates/templates.js":47}],2:[function(require,module,exports){
angular
...
},{"./modules/i18Translations/directives/CPQTranslateDirective.js":48,"./modules/i18Translations/filters/CPQTranslateFilter.js":49,"./modules/i18Translations/services/CPQTranslateResourcesService.js":50,"./modules/i18Translations/services/CPQTranslateService.js":51}],3:[function(require,module,exports){
...
angular.module('hybridCPQ')
    .controller('CPQBundleTransformController', ['$rootScope', '$scope', '$log', '$sldsToast','$timeout', 'CPQService','CPQ_CONST', 'CPQTranslateService', 'TRANSLATION_FIELDS', function($rootScope, $scope, $log, $sldsToast, $timeout, CPQService, CPQ_CONST, CPQTranslateService, TRANSLATION_FIELDS) {
        ...
        var labelsArray = ['CPQCancel','CPQsave','CPQNoResultsFound','CPQSelectExistingOfferToReplace','CPQSelectExistingOfferToReplace',
        ...
        'CPQCurrentSelection','CPQGroup','CPQPrevious','CPQDone','CPQTargetMultiplayBundles','RequiredField','CPQLoadMore','CPQNoneAvailable','CPQAvailableMultiplayBundlesChoices','CPQTransformMultiplayOffers'];
        ...
        function transformMultiFamilyBundle() {
            ...
            for (var i=0; i < multiplayOffersComponentsList.length; i++) {               
                (function(index) {
                    ...
                    function(response) {
                        var responceObject = {record : {}};
                        responceObject.record.response = response;
                        responceObject.record.info = multiplayOffersComponentsList[index];
                        $scope.arrayOfMultiplayComponents.push(responceObject);
                    }, function(error) {
        ...
        $scope.getProductTitle = function (targetProduct) {
            var productTitle, productName, productDesc;
            if (targetProduct.Product2) {
                productName =  CPQTranslateService.translate(targetProduct.Product2.Name, TRANSLATION_FIELDS.PROD2_NAME);
                if (targetProduct.Product2.Description) {
                    productDesc =  CPQTranslateService.translate(targetProduct.Product2.Description, TRANSLATION_FIELDS.PROD2_DESC);
                }
            } else {
                productName =  CPQTranslateService.translate(targetProduct.productName, TRANSLATION_FIELDS.PROD2_NAME);
                if (targetProduct.productDescription) {
                    productDesc =  CPQTranslateService.translate(targetProduct.productDescription, TRANSLATION_FIELDS.PROD2_DESC);
                }
            }
            if (targetProduct.Product2) {
                if (productName && productDesc && targetProduct.ProductCode) {
                    productTitle = productName + ' ' + '|' + ' ' + productDesc + ' ' + '|' + ' ' + targetProduct.ProductCode.value;
                } else if (productName && targetProduct.ProductCode) {
                    productTitle = productName + ' ' + '|' + ' ' + targetProduct.ProductCode.value;
                } else if (productName && productDesc) {
                    productTitle = productName + ' ' + '|' + ' ' + productDesc;
                } else {
                    productTitle = productName;
                }
            } else if (targetProduct.productName) {
                //Need API to send description and product code
                if (productName && productDesc && targetProduct.productCode) {
                    productTitle = productName + ' ' + '|' + ' ' + productDesc + ' ' + '|' + ' ' + targetProduct.productCode;
                } else if (productName && targetProduct.productCode) {
                    productTitle = productName + ' ' + '|' + ' ' + targetProduct.productCode; 
                } else if (productName && productDesc) {
                    productTitle = productName + ' ' + '|' + ' ' + productDesc; 
                } else {
                    productTitle = productName;
        ...
        $scope.getParentProductTitle = function (parentProduct) { 
            var parentProductTitle, productDesc;
            if (parentProduct.parentName)    {
                parentProductName =  CPQTranslateService.translate(parentProduct.parentName, TRANSLATION_FIELDS.PROD2_NAME);
                if (parentProduct.parentDescription) {
                    productDesc =  CPQTranslateService.translate(parentProduct.parentDescription, TRANSLATION_FIELDS.PROD2_DESC);
                }
                if (parentProductName && productDesc && parentProduct.parentCode) {
                    parentProductTitle = parentProductName + ' ' + '|' + ' ' + productDesc + ' ' + '|' + ' ' + parentProduct.parentCode;
                } else if (parentProductName && parentProduct.parentCode) {
                    parentProductTitle = parentProductName + ' ' + '|' + ' ' + parentProduct.parentCode; 
                } else if (parentProductName && productDesc) {
                    parentProductTitle = parentProductName + ' ' + '|' + ' ' + productDesc; 
                } else {
                    parentProductTitle = parentProductName;
                }
            }
            return parentProductTitle;
        }
...
.controller('CPQCartController', ['$scope', '$rootScope', '$log', '$timeout', '$interval','CPQService', 'CPQCustomViewsService', 'CPQSettingsService', 'CPQDiscountService',
 function($scope, $rootScope, $log, $timeout, $interval, CPQService, CPQCustomViewsService, CPQSettingsService, CPQDiscountService) {
    ...
    var labelsArray = ['CPQCart','CPQDetails','CPQLoadMore','CPQPromotions', 'CPQDiscounts', 'CPQCartPricing','CPQCartIsEmpty','CPQCancel','CPQCancelPromotion',
                        ...
                        'CPQAdvancedPricingCostAndMargin'];
...
angular.module('hybridCPQ')
  .controller('CPQCartItemConfigController', ['$scope', '$rootScope', '$log', '$timeout', '$sldsModal', '$sldsToast', 'CPQ_CONST', 'pageService', 'CPQService', 'CPQSettingsService', 'CPQCartItemCrossActionService', 'CPQUtilityService', 'CPQCartItemConfigService','CPQTranslateService','TRANSLATION_FIELDS',
    ...
    var labelsArray = ['CPQClose','CPQSave','CPQCartConfigNoAttrsText','CPQCartConfigAdditionalSetting','CPQCartConfigLookupValues',
        ...
        'CPQCartItemLookupCreateNewInstance', 'CPQCartItemServicePointLabel', 'CPQCartItemPremisesLabel', 'CPQCartItemServicePointSelectLabel'];
...
angular.module('hybridCPQ')
  .controller('CPQCartItemController', ['$scope', '$rootScope', '$log', '$timeout', '$sldsModal', '$sldsPrompt', '$sldsToast', '$q', '$filter', 'CPQ_CONST', 'CPQService', 'CPQSettingsService', 'CPQOverrideService', 'CPQCardinalityService', 'CPQItemDetailsService', 'CPQCartItemCrossActionService', 'CPQLevelBasedApproachService', 'CPQAdjustmentService', 'CPQResponsiveHelper', 'PromiseQueueFactory', 'CPQUtilityService','CPQTranslateService','TRANSLATION_FIELDS',
    function($scope, $rootScope, $log, $timeout, $sldsModal, $sldsPrompt, $sldsToast, $q, $filter, CPQ_CONST, CPQService, CPQSettingsService, CPQOverrideService, CPQCardinalityService, CPQItemDetailsService, CPQCartItemCrossActionService, CPQLevelBasedApproachService, CPQAdjustmentService, CPQResponsiveHelper, PromiseQueueFactory , CPQUtilityService, CPQTranslateService, TRANSLATION_FIELDS) {
        ...
        var labelsArray = ['CPQProducts','CPQPromotions','CPQDiscounts', 'CPQFilter','CPQProductConfig','CPQChangePrice',
                ...
                'CPQCompare','CPQCompareChanges', 'CPQCompareCurrentState', 'CPQCompareFutureState'];
        var toastLabelsArray =  ['CPQAutoRemovedItem','CPQCloneItemFailed','CPQCloningItem','CPQClonedItem','CPQUpdatingItem',
                ...
                'CPQDeletedItem','CPQCancel','CPQMustBeGreaterThanZero','CPQCanNotHaveLess','CPQCanNotHaveMoreThan','CPQMustBeGreaterThanOrEqualToZero','CPQQuantity','CPQSellingPeriodPastMsg','CPQSellingPeriodFutureMsg','CPQSellingPeriodEndOfLifeMsg'];
        CPQService.setLabels(labelsArray, $scope.customLabels);
        // Custom labels for toast messages
        CPQService.setLabels(toastLabelsArray, toastCustomLabels);
        /* End Custom Labels */
        ...
        */
        ...
        function updateConfigPanelData(parent, item, reRenderAttributesForm, isProductGroups) {
            var data, lineItemNode;
            var updateConfigData = true;

            if ($scope.isSelected || isProductGroups) {

                if (isProductGroups) {
                    lineItemNode = CPQService.findLineItemInProductGroups(item);
                    if (lineItemNode) {
                        item = lineItemNode;
        ...
        */
        ...
        $scope.isReadOnly = function(item, parentPsDeleted) {
            return (item[$rootScope.nsPrefix + 'Action__c'] && item[$rootScope.nsPrefix + 'Action__c'].value && item[$rootScope.nsPrefix + 'Action__c'].value.toLowerCase() === 'disconnect' || parentPsDeleted === 'true') ? true : false;
        };
...
angular.module('hybridCPQ')
    .controller('CPQHeaderController', ['$scope', '$rootScope', '$log', '$q', '$timeout', '$window', '$sldsToast', '$sldsPrompt', 'CPQ_CONST', 'CPQService', 'CPQCancelOrderService', 'CPQStreamingChannelService', 'PromiseQueueFactory', '$sldsModal',
        function($scope, $rootScope, $log, $q, $timeout, $window, $sldsToast, $sldsPrompt, CPQ_CONST, CPQService, CPQCancelOrderService, CPQStreamingChannelService, PromiseQueueFactory, $sldsModal) {
       ...
       $scope.progress = CPQCancelOrderService.progress;
        ...
        /* Custom Labels */
        $scope.customLabels = {};
        var labelsArray = ['CPQCancelOrder','CPQCancelOrderLocked','CPQShowMore','CPQTransformMultiplayOffers'];
        CPQService.setLabels(labelsArray, $scope.customLabels);
        /********* Cancel Order **********/
        ...
        unbindObjWatch = $scope.$parent.$watch('obj', function(newValue, oldValue) {
            ...
            if (newValue !== oldValue) {
                if (dataObj && dataObj['OrderStatus__c'] && (dataObj['OrderStatus__c'].toLowerCase() === CPQ_CONST.ORDER_STATUS_CANCEL_REQUESTED)) {
                    if ($scope.$parent.obj) {
...
angular.module('hybridCPQ')
.controller('CPQItemsController', ['$scope', '$rootScope', '$log', '$sldsModal', 'CPQService', 'CPQSettingsService', 'CPQProductPromoListService','CPQSettingsService', 'CPQTranslateService',
    function($scope, $rootScope, $log, $sldsModal, CPQService, CPQSettingsService, CPQProductPromoListService, CPQSettingsService, CPQTranslateService) {
    var customSettings;
    var unbindWatch;
...
angular.module('hybridCPQ')
 ...
 function($scope, $rootScope, $log, $sldsModal, CPQ_CONST, CPQService, CPQSettingsService, CPQCartItemCrossActionService, CPQProductPromoListService, CPQResponsiveHelper, $sldsToast, $q, PromiseQueueFactory, $filter, $timeout, CPQDynamicMessagesService, CPQOverrideService,CPQTranslateService, TRANSLATION_FIELDS, CPQUtilityService) {
    ...
    $scope.customLabels = {};
    var toastCustomLabels = {};
    var labelsArray = ['CPQProductItemTitle','CPQAddToCart','CPQClose','CPQMore','CPQReasons','CPQViewReasons','CPQOr'];
...
angular.module('hybridCPQ')
 ...
 function($scope, $rootScope, $sldsModal, $sldsToast, CPQService, CPQSettingsService, CPQProductPromoListService,CPQ_CONST,CPQUtilityService) {
    ...
    $scope.customLabels = {};
    var toastCustomLabels = {};
    var labelsArray = ['CPQAddToCart','CPQClose','CPQMore','CPQOr','CPQApply','CPQCancel','CPQReplace','CPQReplacementPopUpHeading','CPQReplacementPopUpMessage','CPQReplacePopUpPlanSingular','CPQReplacePopUpPlanPrural','CPQReplacePopUpYouHaveString'];
...
.controller('MultiServiceCPQBaseController', ['$scope', '$rootScope', '$log', '$timeout', '$controller',
    function($scope, $rootScope, $log, $timeout, $controller) {
        ...
        console.log($scope.isConfigAttrsPanelEnabled);
        ...
        $scope.getWidthCSS = function() {
            var widthClass = '';
            if($scope.isConfigAttrsPanelEnabled) {
                if($scope.showProductList) {
                    if($scope.showGroupList) {
                        widthClass = 'slds-large-size_8-of-12';
                    } else {
                        widthClass = 'slds-large-size_7-of-12';
                    }
                } else {
                    if($scope.showGroupList) {
                        widthClass = 'slds-large-size_8-of-12';
                ...
                if($scope.showProductList) {
                    if($scope.showGroupList) {
                        widthClass = 'slds-small-size_3-of-3 slds-medium-size_6-of-6 slds-large-size_12-of-12';
                        //widthClass = 'slds-small-size_2-of-3 slds-medium-size_5-of-6 slds-large-size_8-of-12';
                    } else {
                        widthClass = 'slds-small-size_3-of-3 slds-medium-size_6-of-6 slds-large-size_12-of-12';
                    }
                } else {
                    if($scope.showGroupList) {
                        ...
                        widthClass = 'slds-large-size_9-of-12';
                    }
                }
            }
            return widthClass;
            /*ng-class="{'slds-large-size_8-of-12': importedScope.isConfigAttrsPanelEnabled && importedScope.showProductList && !importedScope.showGroupList,
                        'slds-large-size_7-of-12': importedScope.isConfigAttrsPanelEnabled && importedScope.showProductList && importedScope.showGroupList,
                        'slds-large-size_8-of-12': importedScope.isConfigAttrsPanelEnabled && !importedScope.showProductList && !importedScope.showGroupList,
                        'slds-large-size_8-of-12': importedScope.isConfigAttrsPanelEnabled && !importedScope.showProductList && importedScope.showGroupList,
                        'slds-large-size_8-of-12': !importedScope.isConfigAttrsPanelEnabled && !importedScope.showProductList && !importedScope.showGroupList,
                        'slds-large-size_8-of-12': !importedScope.isConfigAttrsPanelEnabled && importedScope.showProductList && importedScope.showGroupList,
                        'slds-large-size_7-of-12': !importedScope.isConfigAttrsPanelEnabled && !importedScope.showProductList && importedScope.showGroupList,
                        'slds-large-size_9-of-12': !importedScope.isConfigAttrsPanelEnabled && !importedScope.showProductList && !importedScope.showGroupList,
                        'slds-small-size_3-of-3 slds-medium-size_6-of-6 slds-large-size_12-of-12': !importedScope.showGroupList && importedScope.showProductList && !importedScope.isConfigAttrsPanelEnabled}"*/
        }
    }
]);
...
.controller('CPQGroupController', ['$rootScope', '$scope' ,'$filter', '$window','CPQService','$sldsModal', '$timeout','$sldsToast','pageService', 'MultiSerivceCPQService',
    function($rootScope, $scope ,$filter, window,CPQService,$sldsModal, timeout,$sldsToast, pageService, MultiSerivceCPQService) {
        ...
        /*
         * keeping watch on records, incase any change
         */
        $scope.$watch('records.records.length', function(newValue, oldValue) {
         ...
         */
        $scope.init = function(isReinitialize) {
            ...
            var serviceRecords, batchNumber, i, j;
            ...
            if(groupedRecords && groupedRecords.length > 0) {
                ...
                for(i = 0 ; i < $scope.groupList.length ; i++)
                {
                    ...
                    $scope.groupIdToGroup[group.groupId] = group;
                    if(group.groupCart && group.groupCart[$rootScope.nsPrefix + 'TrackingNumber__c']) {
                        batchNumber = group.groupCart[$rootScope.nsPrefix + 'TrackingNumber__c'];
                        if(batchNumber) {
                            $scope.batchIdToGroupId[batchNumber] = group.groupId;
                            $scope.batchIds.push(batchNumber);
                            markAction(group);
                        }
                    ...
                    if(group.groupCartId === $rootScope.cartId) {
                        ...
                        if(batchNumber) {
                            $scope.selectedGroupBatchId = batchNumber;
                ...
                if($scope.batchIds.length > 0 ) {
                    subscribeBatchUpdate();
                }

            }
        }
        /*
         * get grouped services, for each group.
         */
        $scope.getGroupedServices = function(group) {
            if(group.actions.getGroupedServices) {
                var action = group.actions.getGroupedServices;
                group.isLoading = true;
                var groupedServicePageSize = 100, temp;
                if(action.remote && action.remote.params) {
                    temp = parseInt($scope.params.groupedServicePageSize);
                    if(temp) {
                        groupedServicePageSize = temp;
                    }
                    action.remote.params.pageSize = groupedServicePageSize;
                    action.remote.params.offset = 0;
                }
                MultiSerivceCPQService.invokeAction(group.actions.getGroupedServices).then(
                    function(data) {
                        if(data.records) {
                            group.services = data.records;
                            if(group.services) {
                                for(var i=0; i<group.services.length; i++) {
                                    group.services[i].applyToGroup = group.applyToGroup;
                                    group.services[i].priceValidate = group.priceValidate;
                                }
                            }
                            if(data.actions && data.actions.getGroupedServices) {
                                group.actions.getGroupedServices = data.actions.getGroupedServices;
                            }
                        }
        ...
        $scope.getBatchUpdate = function() {
            if(!$scope.batchIds || $scope.batchIds.length === 0) {
                return;
            }
            ...
            var inputMap = {
                ...
                'selectedGroupBatchId': $scope.selectedGroupBatchId,
                'opportunityId': $scope.params.parentId
            };

            MultiSerivceCPQService.invokeRemote('getBatchUpdate', inputMap).then(
                function(data) {
                    if(!data) {
                        unsubscribeBatchUpdate();
                        return;
                    ...
                    var batchDetails, group, temp, batchName;
                    for(var batchId in result) {
                        batchDetails = result[batchId];
                        temp = $scope.batchIdToGroupId[batchId]
                        group = $scope.groupIdToGroup[temp];
                        if(batchDetails.batch.Status === 'Completed' ||
                            batchDetails.batch.Status === 'Aborted' ||
                            batchDetails.batch.Status === 'Failed') {
                            group[batchDetails.action] = false;
                            if(group.groupCartId === $rootScope.cartId) {
                                $rootScope.isToDisableGroupButton = false;
                                reloadTotalBar();
                                reloadGroupList();
                            }
                            //remove from batchIds.
                            for( i = 0; i < $scope.batchIds.length; i++) {
                                if ( $scope.batchIds[i] === batchId) {
                                    $scope.batchIds.splice(i, 1);
                                    break;
                                }
                            }
                        } else {
                            group[batchDetails.action] = true;
                            //update services
                            updatedQuotes = batchDetails.updatedQuote;
                            updateQuotes(group, updatedQuotes, batchDetails.serviceToQuote, batchDetails.action);
                        }
                    }
                    if($scope.batchIds.length === 0) {
                        unsubscribeBatchUpdate();
        ...
        function markAction(group) {
            if(!group.services) {
                return;
            }
            var action;
            if($scope.params.applyToGroup === 'true') {
                action = 'applyToGroup';
            } else if($scope.params.priceValidate === 'true') {
                action = 'priceValidate';
            }
            if(!action) {
                return;
            }
            ...
            group[action] = true;
            var serviceRecords = group.services;
            var i, j;
            for(i = 0; i < serviceRecords.length; i++) {
                serviceRecords[i][action] = true;
                if(action === 'applyToGroup' && serviceRecords[i].quote) {
                    //setting to false
                    serviceRecords[i].quote[$rootScope.nsPrefix + 'IsValidated__c'] = false;
                    serviceRecords[i].quote[$rootScope.nsPrefix + 'IsPriced__c'] = false;
                }
            }
        }

        function updateQuotes(group, updatedQuote, serviceToQuote, action) {
            if(!group.services) {
                return;
            }
            var serviceRecords = group.services;
            var i, quote;
            for(i = 0; i < serviceRecords.length; i++) {
                if(!serviceRecords[i].quoteId && serviceToQuote) {
                    serviceRecords[i].quoteId = serviceToQuote[serviceRecords[i].Id.value];
                }
                quote = updatedQuote[serviceRecords[i].quoteId];
                if(quote) {
                    serviceRecords[i][action] = false;
                    if(!serviceRecords[i].quote) {
                        serviceRecords[i].quote = {};
                    }
                    serviceRecords[i].quote[$rootScope.nsPrefix + 'IsValidated__c'] = quote[$rootScope.nsPrefix + 'IsValidated__c'];
                    serviceRecords[i].quote[$rootScope.nsPrefix + 'IsPriced__c'] = quote[$rootScope.nsPrefix + 'IsPriced__c'];
                }
            }
        }

        function unsubscribeBatchUpdate() {
            if($scope.batchUpdateInterval) {
                clearInterval($scope.batchUpdateInterval);
            }
        }

        function subscribeBatchUpdate() {
            $scope.batchUpdateInterval = setInterval($scope.getBatchUpdate, 3000);
        }
...
angular.module('hybridCPQ')
.controller('GroupCPQTotalController', ['$scope', '$controller', '$sldsModal', 'pageService', 'CPQService',
    function($scope, $controller, $sldsModal, pageService, CPQService) {
        //doing inheritance
        $controller('CPQTotalController', {$scope: $scope});

        var labelsArray = ['CPQApplyToGroupMessage', 'CPQClose', 'CPQApplyToGroup', 'CPQPriceValidateLabel', 'CPQPriceValidateMessage'];
        CPQService.setLabels(labelsArray, $scope.customLabels);
...
.factory('CPQAdjustmentService', ['$rootScope', '$q', '$log', 'CPQ_CONST', 'CPQService', '$sldsModal', '$sldsToast', 'CPQTranslateService', 'TRANSLATION_FIELDS',
    ...
    var dataRecords,adjustmentData;
    ...
    function invokeSubmitCancelOrderAction (data) {
        if (data.actions && data.actions.submitcancelorder) {
            ...
            CPQService.invokeAction(getSubmitCancelOrderAction).then(function(data) {
                if (data.records) {
                    switch(data.records[0][$rootScope.nsPrefix + 'OrderStatus__c'].toLowerCase()) {
            ...
            if (addonProductFromAPI && addonProductFromAPI.minQuantity === 0 && addonProductFromAPI.defaultQuantity > 0) {
                ...
                if (!parentInCardData.actions || (parentInCardData.actions && !parentInCardData.actions.getproducts)) {
                    ...
                    for (i = 0; i < numOfLineItemsUnderParent; i++) {
                        ...
                        actionStatusDisconnected = lineItemUnderParent[$rootScope.nsPrefix + 'Action__c'] && lineItemUnderParent[$rootScope.nsPrefix + 'Action__c'].value.toLowerCase() === 'disconnect' ? true : false;
...
angular.module('hybridCPQ')
    .factory('CPQService', ['$log', '$q', '$timeout', '$rootScope', '$filter', '$locale', 'CPQ_CONST', 'dataSourceService', 'dataService', 'CPQSettingsService',
        function($log, $q, $timeout, $rootScope ,$filter, $locale, CPQ_CONST, dataSourceService, dataService, CPQSettingsService) {
...
angular.module('hybridCPQ')
.factory('CPQStreamingChannelService', ['$log', 'configService', 'dataService', function($log, configService, dataService) {
